...
def get_transcription(link):
    ...
    aai.settings.api_key = "634f7cd7021a4491bd9e72c50ade425d"
...
def generate_blog_from_transcription(transcription):
    ...
    client = OpenAI(api_key="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")
    ...
    if request.method == 'POST':
        ...
        if password == repeatPassword:
            try:
                ...
                return render(render, 'signup.html', {'error_message'})
        else:
